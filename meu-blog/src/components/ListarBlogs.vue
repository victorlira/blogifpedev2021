...
export default {
    ...
    data() {
        return {
            ...
            filtroDescricao: '',
            blogs: [
                { id: 1, titulo: 'Geek-Blog Marvel', descricao: 'Textos diários sobre a Marvel', assunto: 'Geek' },
                { id: 2, titulo: 'Tecnologia em dia', descricao: 'Novidades e atualizações sobre o setor de alta tecnologia', assunto: 'Tecnologia da Informação'},
                { id: 3, titulo: 'Digital Law', descricao: 'Blog sobre o Direito Digital', assunto: 'Direito'},
                { id: 4, titulo: 'Filosofia 2015', descricao: 'Desde 2015 tratando sobre filosofia clássica', assunto: 'Filosofia'},
                { id: 5, titulo: 'História em dia', descricao: 'Conto aqui a história do Brasil de um jeito lúdico e diferente', assunto: 'História'},
                { id: 6, titulo: 'O viajante', descricao: 'Relatos diários de um viajante compulsivo', assunto: 'Viagens'},
            ],
            blogsFiltrados: []
        }
    },
    methods: {
        buscar() {
            this.blogsFiltrados = this.blogs.filter(blog => blog.titulo.toLowerCase().includes(this.filtroTitulo.toLowerCase()));
            
            this.blogsFiltrados = this.blogsFiltrados.filter(blog => blog.descricao.toLowerCase().includes(this.filtroDescricao.toLowerCase()))
        },
        remover(id) {
